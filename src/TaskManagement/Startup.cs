...
namespace TaskManagement
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("TaskManagement"));
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "TaskManagement API", Version = "v1" });
