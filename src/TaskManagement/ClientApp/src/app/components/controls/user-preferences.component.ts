...
import { AlertService, MessageType, MessageSeverity } from '../../services/message.service';
...
export class UserPreferencesComponent implements OnInit, OnDestroy {
  ...
  setAsDefault() {
    this.alertService.showDialog('Are you sure you want to set the current configuration as your new defaults?', MessageType.confirm,
  ...
  resetDefault() {
    this.alertService.showDialog('Are you sure you want to reset your defaults?', MessageType.confirm,
