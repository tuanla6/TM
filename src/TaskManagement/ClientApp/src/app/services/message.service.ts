...
export class MessageDialog {
  constructor(public message: string, public type: MessageType, public okCallback: (val?: any) => any, public cancelCallback: () => any,
...
export class AlertService {
  ...
  private dialogs = new Subject<MessageDialog>();

  private _isLoading = false;
  private loadingMessageId: any;


  showDialog(message: string, type?: MessageType, okCallback?: (val?: any) => any, cancelCallback?: () => any, okLabel?: string,
  ...
  getDialogEvent(): Observable<MessageDialog> {
